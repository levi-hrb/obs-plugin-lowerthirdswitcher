...
function(set_target_properties_plugin target)
  ...
  add_custom_command(
    ...
    COMMAND "${CMAKE_COMMAND}" -E copy_directory "$<TARGET_BUNDLE_DIR:${target}>"
  ...
  configure_file(cmake/macos/resources/distribution.in "${CMAKE_CURRENT_BINARY_DIR}/distribution"
                 @ONLY)
  configure_file(cmake/macos/resources/create-package.cmake.in
